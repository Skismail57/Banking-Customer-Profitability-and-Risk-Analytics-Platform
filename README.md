...
| **Included UI evidence** | **55 screenshots**, grouped below so every screenshot renders in the README |
...
├── assets/screenshots/     # 55 UI/API screenshots
...
**All 55 screenshots from the project archive are included below.** They have been copied to clean, GitHub-safe filenames under `assets/screenshots/` so filenames containing spaces or `#` characters do not break image rendering.
